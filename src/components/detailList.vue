    ...
    <div class="h100 w100" v-if="show===0">
      <q-header elevated>
        <q-toolbar class="bg-top_Nav-color text-top">
          ...
          <q-toolbar-title>{{detailList.projectName}}</q-toolbar-title>
                    ...
                    <q-list dense class="smallList" @click="edits(items,index)">
                      ...
                      <div class="row justify-start" v-if="items.largeClass === '模具基本信息'">
                        ...
                        <div class="col-6">
                          <p>
                            A
                            <b class="border_solid_bottom_c pl5 pr5">{{items.alength}}</b> mm
                          </p>
                          <p>
                            B1
                            <b class="border_solid_bottom_c pl5 pr5">{{items.b1Length}}</b> mm
                          </p>
                          <p>
                            B2
                            <b class="border_solid_bottom_c pl5 pr5">{{items.b2Length}}</b> mm
                          </p>
                          <p>
                            模具总重量
                            <b class="border_solid_bottom_c pl5 pr5">{{items.totalWeight}}</b> kg
                          </p>
                          <p>
                            定模侧重量
                            <b class="border_solid_bottom_c pl5 pr5">{{items.fixedWeight}}</b> kg
                          </p>
                          <p>
                            动模侧重量
                            <b class="border_solid_bottom_c pl5 pr5">{{items.dynamicWeight}}</b> kg
                          </p>
                        </div>
                        ...
                        <div class="col-6">
                          <p>
                            a
                            <b class="border_solid_bottom_c pl5 pr5">{{items.a1Length}}</b> mm
                          </p>
                          <p>
                            b
                            <b class="border_solid_bottom_c pl5 pr5">{{items.blength}}</b> mm
                          </p>
                          <p>
                            c
                            <b class="border_solid_bottom_c pl5 pr5">{{items.clength}}</b> mm
                          </p>
                          <p>
                            一级顶行程
                            <b class="border_solid_bottom_c pl5 pr5">{{items.firstTopTrip}}</b> kg
                          </p>
                          <p>
                            二级顶行程
                            <b class="border_solid_bottom_c pl5 pr5">{{items.secondTopTrip}}</b> kg
                          </p>
                          <p>
                            三级顶行程
                            <b class="border_solid_bottom_c pl5 pr5">{{items.thirdTopTrip}}</b> kg
                          </p>
                        </div>
                      </div>
                      <!-- DESIGN LIST -->
                      ...
                      <div v-else>
                        <div class="col mb20" v-for="(item,index) in items.list" :key="index">
                          <div
                            v-if="(item.confirmor !== 'YFPO 工厂确认'&& items.largeClass === 'T1认可前检查') || item.largeClass !=='T1认可前检查'"
                          >
...
export default {
  ...
  methods: {
    // get toolInformation
    async getTool() {
      let res = await getToolInformationByMouldNo({
    ...
    async getDetailListInfo() {
      let res = await getApproveStatistics({
        mouldNo: this.$store.getters.mould_list.mouldNo
      });
      let res1 = await getDesignStatistics({
        mouldNo: this.$store.getters.mould_list.mouldNo
      });
